...
_steps = [
    ...
    # Training the sample-data with  some other Regression models
...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "train_random_forest" in active_steps:
            ...
            # NOTE: We will use the rf_config we just created as the rf_config parameter for the train_random_forest
            # step
        ...
        if "train_linear_regression" in active_steps:
            ...
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    "stratify_by": config["modeling"]["stratify_by"],
                    "max_tfidf_features": config["modeling"]["max_tfidf_features"],
                    "output_artifact": "linear_regression_export"})
