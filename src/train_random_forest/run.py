...
def get_inference_pipeline(rf_config, max_tfidf_features):
    # We handle the categorical features first
    ...
    # skewness
    logger.info("Added Skewness Fixer")
    ...
    # We connect everything together in the ColumnTransformer
...
def go(args):
    ...
    # We get the Random Forest configuration and update W&B
    ...
    # Then we fit it to the X_train, y_train data
    logger.info("Fitting")
    ...
    # We upload the feature importance visualization to W&B
    run.log(
        {
