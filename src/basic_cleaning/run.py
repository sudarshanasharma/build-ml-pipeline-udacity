...
def go(args):
    ...
    # We save the cleaned dataset as an Artifact
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--min_latitude",
        type=float,
        help="Minimum latitude for geographical boundary",
        required=True
    )
    ...
    parser.add_argument(
        "--min_longitude",
        type=float,
        help="Minimum longitude for geographical boundary",
        required=True
    )
    ...
    parser.add_argument(
        "--max_longitude",
        type=float,
        help="Maximum longitude for geographical boundary",
        required=True
    )
